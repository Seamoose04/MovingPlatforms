...
namespace pathfinder {
    ...
    //% block="AutoCreateMovingPlatforms. Platform tile $platform_image=tileset_tile_picker=tileset_tile_picker, Start tile $start_image=tileset_tile_picker, End tile $end_image, Background tile $background_image=tileset_tile_picker."
